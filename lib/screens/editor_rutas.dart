            ...
            Container(
              ...
              child: Consumer<ControllerEditorRutas>(
                ...
                return Row(
                  ...
                  children: [
                    botonHorarios(
                        "LU", controllerEditorRutas.modeloSemana?.dayLu, 0),
                    botonHorarios(
                        "MA", controllerEditorRutas.modeloSemana?.dayMa, 1),
                    botonHorarios(
                        "MI", controllerEditorRutas.modeloSemana?.dayMi, 2),
                    botonHorarios(
                        "JU", controllerEditorRutas.modeloSemana?.dayJu, 3),
                    botonHorarios(
                        "VI", controllerEditorRutas.modeloSemana?.dayVi, 4),
                    botonHorarios(
                        "SA", controllerEditorRutas.modeloSemana?.daySa, 5),
                    botonHorarios(
                        "DO", controllerEditorRutas.modeloSemana?.dayDo, 6),
                  ],
                );
              }),
            ),
...
//
  ElevatedButton botonHorarios(String dia, bool? controller, int posicion) {
  ...
  Container botonServicios(String routeIcon, bool? controller, void function) {
    return Container(
